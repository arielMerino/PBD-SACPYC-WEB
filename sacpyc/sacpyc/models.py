...
class CompraIngrediente(models.Model):
    ...
    idproveedoringrediente = models.ForeignKey('ProveedorIngrediente', db_column='IDPROVEEDORINGREDIENTE')  # Field name made lowercase.
    ...
    fecha_compra_ingrediente = models.DateField(db_column='FECHA_COMPRA_INGREDIENTE', blank=True, null=True)  # Field name made lowercase.
...
class CompraUtensilio(models.Model):
    ...
    idproveedorutensilio = models.ForeignKey('ProveedorUtensilio', db_column='IDPROVEEDORUTENSILIO')  # Field name made lowercase.
...
class Item(models.Model):
    ...
    idtipo = models.ForeignKey('TipoItem', db_column='IDTIPO')  # Field name made lowercase.
